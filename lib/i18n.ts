...
export const STR: Record<string, Triple> = {
  ...
  cg_purchase: ["Olindi", "Олинди", "Приход"],
  cg_payment_out: ["To'landi", "Тўланди", "Оплата"],
  cg_charge: ["Berildi", "Берилди", "Отгрузка"],
  cg_payment_in: ["Qabul qilindi", "Қабул қилинди", "Поступление"],
  cg_purchased: ["Jami olindi", "Жами олинди", "Всего приход"],
  cg_paid: ["Jami to'landi", "Жами тўланди", "Всего оплачено"],
  cg_charged: ["Jami berildi", "Жами берилди", "Всего отгружено"],
  cg_received: ["Jami qabul qilindi", "Жами қабул қилинди", "Всего поступило"],
